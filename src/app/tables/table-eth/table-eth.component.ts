...
@Component({
  ...
  templateUrl: './table-eth.component.html',
  styleUrls: ['./table-eth.component.css'],
  changeDetection: ChangeDetectionStrategy.Default,
})
export class TableETHComponent implements OnInit {
    ...
    displayedColumns = ['timestamp', 'USD', 'EUR', 'BTC'];
	...
	ngOnInit() {
    	...
    	Observable.interval(10000).subscribe(x => {
	    	this.currencies = this.dataService.getArrayETH();
